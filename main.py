...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        # Используем HTML для отображения SVG изображения branch.svg
        st.markdown("""
        <div style="display: flex; align-items: center; margin-bottom: 1rem;">
            <img src="data:image/svg+xml;base64,{}" width="24" height="24" style="margin-right: 8px;">
            <h3 style="margin: 0;">Выбор раздела</h3>
        </div>
        """.format("""
        <svg xmlns="http://www.w3.org/2000/svg" width="38" height="51" viewBox="0 0 38 51" fill="none"><path d="M19.7071 0.292893C19.3166 -0.0976311 18.6834 -0.0976311 18.2929 0.292893L11.9289 6.65685C11.5384 7.04738 11.5384 7.68054 11.9289 8.07107C12.3195 8.46159 12.9526 8.46159 13.3431 8.07107L19 2.41421L24.6569 8.07107C25.0474 8.46159 25.6805 8.46159 26.0711 8.07107C26.4616 7.68054 26.4616 7.04738 26.0711 6.65685L19.7071 0.292893ZM18 1L18 51L20 51L20 1L18 1Z" fill="black"></path><path d="M37.7071 32.2929C38.0976 32.6834 38.0976 33.3166 37.7071 33.7071L31.3431 40.0711C30.9526 40.4616 30.3195 40.4616 29.9289 40.0711C29.5384 39.6805 29.5384 39.0474 29.9289 38.6569L35.5858 33L29.9289 27.3431C29.5384 26.9526 29.5384 26.3195 29.9289 25.9289C30.3195 25.5384 30.9526 25.5384 31.3431 25.9289L37.7071 32.2929ZM37 34C27.6112 34 20 41.6112 20 51H18C18 40.5066 26.5066 32 37 32V34Z" fill="#C63031"></path><path d="M0.292892 18.2929C-0.0976315 18.6834 -0.0976315 19.3166 0.292892 19.7071L6.65685 26.0711C7.04738 26.4616 7.68054 26.4616 8.07107 26.0711C8.46159 25.6805 8.46159 25.0474 8.07107 24.6569L2.41421 19L8.07107 13.3431C8.46159 12.9526 8.46159 12.3195 8.07107 11.9289C7.68054 11.5384 7.04738 11.5384 6.65685 11.9289L0.292892 18.2929ZM1 20C10.3888 20 18 27.6112 18 37H20C20 26.5066 11.4934 18 1 18V20ZM18 37V51H20V37H18Z" fill="#C63031"></path></svg>
        """.encode().decode()), unsafe_allow_html=True)
